...
def main() -> None:
    parser = argparse.ArgumentParser(description="局部爬取香港马会全日赛果 / 派彩页面。")
    ...
    url = client.race_results_all_url(args.race_date)
    result = client.scrape_url("dividends", url, args.race_date)
